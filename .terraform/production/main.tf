...
module "ecs_cluster" {
  ...
  number_of_instances     = module.variables.min_task_count_cluster
  min_number_of_instances = module.variables.min_task_count_cluster
  max_number_of_instances = module.variables.max_task_count_cluster
