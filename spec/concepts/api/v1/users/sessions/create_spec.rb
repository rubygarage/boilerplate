...
RSpec.describe Api::V1::Users::Sessions::Operation::Create do
  ...
  describe 'Failure' do
    context 'without params' do
      let(:errors) { { email: [I18n.t('dry_schema.errors.key?')], password: [I18n.t('dry_schema.errors.key?')] } }
    ...
    context 'with empty params' do
      ...
      let(:errors) { { email: [I18n.t('dry_schema.errors.filled?')], password: [I18n.t('dry_schema.errors.filled?')] } }
    ...
    context 'with wrong params type' do
      ...
      let(:errors) { { email: [I18n.t('dry_schema.errors.str?')], password: [I18n.t('dry_schema.errors.str?')] } }
